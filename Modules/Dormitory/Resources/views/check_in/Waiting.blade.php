...
@php
    ...
    $page_name = 'เช็คอินรอย้ายออก';
    $page_title = 'เช็คอินรอย้ายออก';
                    ...
                    <tbody>
                        @forelse ($data as $item)
                            <tr>
                                ...
                                <td >
                                    <a href="{{ route('dormitorys.check_in.change', $item->id) }}" class="btn btn-success btn-rounded" role="button">
                                        ย้ายเข้า
                                    </a>
                                </td>
                            </tr>
...
<a href="{{ route('dormitorys.check_in.index',$dormitory->code) }}" class="btn btn-secondary btn-rounded text-dark" style="float:right; margin-right: 20px;">
