...
@php
    ...
    $page_name = 'เช็คอินออก';
    $page_title = 'เช็คอินออก';
...
<div class="p-5 mt-n5 mb-3 mx-n5 text-dark" style="background-attachment: fixed; height: 250px; background-color: #333333;">
    <div class="text-center" style="font-size: 20px; color: #ffffff;">เช็คอินออก</div>
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-8 mt-3">
                <div class="d-flex justify-content-between">
                    <a href="{{ route('dormitorys.check_out.Waiting', $dormitory->code) }}" style="width: 48%;">
                    ...
                    <a href="{{ route('dormitorys.check_out.out', $dormitory->code) }}" style="width: 48%;">
                        <div class="card shadow room-card" style="border-radius: 10px; color: #000000;">
                            <div class="card-body pt-4">
                                <div>ย้ายออกแล้ว</div>
                                <div class="mt-1">
                                    <i class="mdi mdi-accounts" title="จำนวนผู้ย้ายออกแล้ว"></i> {{$out_count}}
                                </div>
                            </div>
                        </div>
                    </a>
