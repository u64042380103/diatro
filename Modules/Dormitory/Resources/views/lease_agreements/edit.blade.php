...
<div class="row justify-content-center">
    <div class="col-sm-8 col-md-5">
            ...
            <div class="card-body" style="padding: 20px;">
                <form method="POST" action="{{ route('dormitorys.lease_agreements.update', $data->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="inputfile" id="img" type="file" name="img" accept="image/*" required onchange="previewImage(event)">
                        <label class="btn-secondary" id="btnImg" for="img"><i class="mdi mdi-upload"></i><span id="nameImg">เลือกรูปภาพประจำตัว . . . . .</span>
                    </div>
                    <div class="form-group">
        ...
        <a href="{{ route('dormitorys.lease_agreements.show', $data_room->id) }}" class="btn btn-secondary btn-rounded text-dark" style="float:right; margin-right: 20px;">
